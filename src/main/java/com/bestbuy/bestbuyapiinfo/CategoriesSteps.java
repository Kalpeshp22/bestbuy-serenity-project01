...
import com.bestbuy.constants.EndPoints;
import com.bestbuy.model.CategoroiesPojo;
...
public class CategoriesSteps {
    ...
    public ValidatableResponse createCategory(String name, String id) {
        CategoroiesPojo categoriesPojo = new CategoroiesPojo();
    ...
    public ValidatableResponse updateCategory(String name, String categoriesId) {
        CategoroiesPojo categoriesPojo = CategoroiesPojo.getCategoriesPojo(name, categoriesId);
